...
abstracton       %% print header "Abstract"
]{scrartcl}
...
\clearpage
\SweaveInput{src/intro.Rnw}

\clearpage
\SweaveInput{src/specialgenerators.Rnw}
\clearpage
\SweaveInput{src/universal.Rnw}
\clearpage
\SweaveInput{src/distributions.Rnw}
\clearpage
\SweaveInput{src/advanced.Rnw}

% ---------------------------------------------------------------------------
\appendix

\clearpage
\SweaveInput{src/arvag.Rnw}
\clearpage
\SweaveInput{src/pitfalls.Rnw}
\clearpage
\SweaveInput{src/glossary.tex}
